...
// that consumes it.
//
// LIA-496: ported byte-identical from LIA-495's
// web-first-demo/src/runtime/virtualFs.ts into the shared package — this
// module has zero presentation values, so it needed no adaptation for the
// "tokens.ts lesson" (see shared/src/status.ts for the module that DID).
