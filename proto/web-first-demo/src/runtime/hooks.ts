// LIA-495 — state-derivation hooks ported from full-shell.tsx. All of these
// read from `useAuiState`, which is re-exported unchanged by both
...
// per-tool-call `.approval`/`.result`) is identical on web. Only the import
// specifier changed (`@assistant-ui/react` instead of
