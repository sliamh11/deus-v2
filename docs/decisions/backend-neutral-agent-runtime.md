...
| Group-level backend opt-in | Verified Pass | `/settings backend=deus-native` + resolver behavior covered by this PR's new automated tests; not yet exercised in a live deployment. |
