---
name: customize
description: Add new capabilities or modify Deus behavior. Use when user wants to add channels (Telegram, Slack, email input), change triggers, add integrations, modify the router, or make any other customizations. This is an interactive skill that asks questions to understand what the user wants.
---
...
1. Ask: "Should Telegram use the same @Deus trigger, or a different one?"
