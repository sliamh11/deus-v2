...
1. Start Deus in dev mode: `npm run dev`
...
```bash
git clone <your-fork> /tmp/deus-test
cd /tmp/deus-test
...
- **No config file.** Deus's philosophy is customization through code changes, not configuration sprawl.
