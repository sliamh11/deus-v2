...
* **agents:** session-retrospective proposes procedure candidates (LIA-337) ([#950](https://github.com/sliamh11/Deus/issues/950)) ([2fd0a35](https://github.com/sliamh11/Deus/commit/2fd0a351d3da26f74a00b15ff0622276f69ff7df))
* **channels:** add Microsoft Teams channel via Bot Framework (LIA-330) ([#938](https://github.com/sliamh11/Deus/issues/938)) ([6c27f81](https://github.com/sliamh11/Deus/commit/6c27f819f4c5ad06e000f3d90eb3d3c5755ccb93))
* **channels:** add Outlook (Microsoft 365) channel via Microsoft Graph (LIA-330) ([#937](https://github.com/sliamh11/Deus/issues/937)) ([e93039f](https://github.com/sliamh11/Deus/commit/e93039f5366b3f1cfe1711993ee3daf3e4b60a9c))
* **cli:** add `deus deploy` — diff-driven conditional deploy ([#934](https://github.com/sliamh11/Deus/issues/934)) ([5fae89b](https://github.com/sliamh11/Deus/commit/5fae89ba45059668f6b024527356fc31127e1edd))
* **cli:** repurpose `deus web` to launch the Open WebUI ([#849](https://github.com/sliamh11/Deus/issues/849)) ([0ab1ffc](https://github.com/sliamh11/Deus/commit/0ab1ffc218147418fee2bcc975865f57aab3ab82))
* **cli:** switch `deus web` from Docker to uvx Open WebUI launcher ([#852](https://github.com/sliamh11/Deus/issues/852)) ([11e0859](https://github.com/sliamh11/Deus/commit/11e08594032cad0b2d6e2d254fcd2eee47a00a21))
* **eval:** advisory safety-recall regression gate with versioned floor (LIA-321) ([#913](https://github.com/sliamh11/Deus/issues/913)) ([c2e605a](https://github.com/sliamh11/Deus/commit/c2e605a124e73ffe64a23c9c59d95081b509e88c))
* **eval:** flip safety-recall gate to blocking, hardened against judge infra failures (LIA-326) ([#921](https://github.com/sliamh11/Deus/issues/921)) ([0a58421](https://github.com/sliamh11/Deus/commit/0a58421df018d038661b7d3e9f3dd0327fd1a5b4))
* **eval:** honest Gemini floor + secret preflight for safety-recall gate (LIA-326) ([#917](https://github.com/sliamh11/Deus/issues/917)) ([ac85885](https://github.com/sliamh11/Deus/commit/ac858857301e8cf0bcff777b20fdcb87f0449cfb))
* **ingress:** add R5 DoS/spend caps + R6 per-event audit (LIA-315 Phase 3) ([#890](https://github.com/sliamh11/Deus/issues/890)) ([260ad1d](https://github.com/sliamh11/Deus/commit/260ad1d1be30cb84f3207c94add1781b1964a37f))
* **ingress:** centralized ingress gateway + ngrok tunnel module (Phase 1) ([#877](https://github.com/sliamh11/Deus/issues/877)) ([de05ce1](https://github.com/sliamh11/Deus/commit/de05ce1bdc49ad7b5317023b8fd441b1b0b9b712))
* **ingress:** generic webhook channel + leak-free R5/R6 caps wiring (LIA-315 Phase 4) ([#906](https://github.com/sliamh11/Deus/issues/906)) ([35b79cc](https://github.com/sliamh11/Deus/commit/35b79cc57e2cc2411ff2d680c8b635e6b1193062))
* **ingress:** GitHub CI/PR webhook → gateway (/github) — push, not polling (LIA-315 Phase 4) ([#903](https://github.com/sliamh11/Deus/issues/903)) ([0490dc6](https://github.com/sliamh11/Deus/commit/0490dc6818604df284c1dc1d41383946538b2fa1))
* **ingress:** quiet-hours gate to defer autonomous merges to a nightly window (LIA-321) ([#911](https://github.com/sliamh11/Deus/issues/911)) ([5b110cd](https://github.com/sliamh11/Deus/commit/5b110cde728c44016ca46d6cdd4a6c79964e4def))
* **ingress:** reduced-privilege webhook profile + per-token tool scope (LIA-315 Phase 2) ([#886](https://github.com/sliamh11/Deus/issues/886)) ([fcb16bc](https://github.com/sliamh11/Deus/commit/fcb16bc436908497f84412cd5f50661aa01f48e7))
* **ingress:** route Linear webhooks through the gateway (/linear) (LIA-315 Phase 5) ([#889](https://github.com/sliamh11/Deus/issues/889)) ([4544230](https://github.com/sliamh11/Deus/commit/45442304100d0d38c07498e46b406d1a48164247))
* **linear-sync:** exclude Icebox state from the pending-block sync ([#837](https://github.com/sliamh11/Deus/issues/837)) ([170d2dc](https://github.com/sliamh11/Deus/commit/170d2dc60d287e7c49830ec181ed9b2014db7cbd))
* **linear-sync:** paginate pending-issue fetch instead of capping at 50 (LIA-298) ([#834](https://github.com/sliamh11/Deus/issues/834)) ([48dd3e6](https://github.com/sliamh11/Deus/commit/48dd3e69f92ad271e703e74ea9eb53942f74f958))
* **maintenance:** morning memory report — daily "while you slept" digest (LIA-254) ([#932](https://github.com/sliamh11/Deus/issues/932)) ([4c388d4](https://github.com/sliamh11/Deus/commit/4c388d426b3cecf6e0fb83f312822467b6c334e9))
* **maintenance:** nightly credential expiry probe for Codex + gcal ([#920](https://github.com/sliamh11/Deus/issues/920)) ([45380f2](https://github.com/sliamh11/Deus/commit/45380f246f39f34720a75940bbb83021a68fe594))
* **maintenance:** rotate the unbounded memory-tree query log (LIA-218) ([#918](https://github.com/sliamh11/Deus/issues/918)) ([2264548](https://github.com/sliamh11/Deus/commit/22645483b3d1da516f65393d448b4b724a8ff601))
* **maintenance:** weekly local judge-calibration watchdog (LIA-261) ([#930](https://github.com/sliamh11/Deus/issues/930)) ([7cf64d3](https://github.com/sliamh11/Deus/commit/7cf64d37bac21f6727c1167188f2f8e8d0d4edbe))
* **memory:** e2b post-retrieval intent gate cuts procedure false-fires (LIA-337) ([#957](https://github.com/sliamh11/Deus/issues/957)) ([8e737cf](https://github.com/sliamh11/Deus/commit/8e737cf60a65ee209edddf5c1b8697e657c76724))
* **memory:** extract shared consolidateSessionLog core (LIA-302 Phase 1) ([#853](https://github.com/sliamh11/Deus/issues/853)) ([f663878](https://github.com/sliamh11/Deus/commit/f663878e96a1f92d00062bed447ca671ec84780f))
* **memory:** local fallback chain for the procedure intent gate (LIA-342) ([#959](https://github.com/sliamh11/Deus/issues/959)) ([e217645](https://github.com/sliamh11/Deus/commit/e217645784d7e283a4efcaf909b65dd6fa86f82d))
* **memory:** procedure-memory MVP - capture skill + opt-in surfacing (LIA-334) ([#941](https://github.com/sliamh11/Deus/issues/941)) ([cf10015](https://github.com/sliamh11/Deus/commit/cf1001575cd22c2d5cb556cbec519add1bf8fa22))
* **memory:** read-time injection boundary on recalled memory (LIA-335) ([#944](https://github.com/sliamh11/Deus/issues/944)) ([d7ce360](https://github.com/sliamh11/Deus/commit/d7ce36009c52f84bf8aaffc702ce6c001dfeccae))
* **memory:** surface review-backlog count in cmd_extract (LIA-338) ([#952](https://github.com/sliamh11/Deus/issues/952)) ([8324241](https://github.com/sliamh11/Deus/commit/8324241b651d67d5eabf69710a018f550efbc0a3))
* **multi-agent:** route deus-tasks blocks to orchestrator on cold + warm turns (LIA-127) ([#958](https://github.com/sliamh11/Deus/issues/958)) ([9a1572f](https://github.com/sliamh11/Deus/commit/9a1572f12835ad640700ff16246fb287b6f60ac9))
* **nonumb:** stateful learning cards + independent quiz authoring (LIA-328 P2/P4) ([#919](https://github.com/sliamh11/Deus/issues/919)) ([cb6900a](https://github.com/sliamh11/Deus/commit/cb6900a5feeaf7e155fc883d7bafc379b5179e7b))
* **odysseus:** auto-consolidate Web UI conversations into vault memory (LIA-295) ([#850](https://github.com/sliamh11/Deus/issues/850)) ([f4da7b4](https://github.com/sliamh11/Deus/commit/f4da7b4f7ffb6ae3f0615af82bac6ffda6920e88))
* **odysseus:** stream Web UI chat output incrementally + Thinking indicator ([#851](https://github.com/sliamh11/Deus/issues/851)) ([cd19ac0](https://github.com/sliamh11/Deus/commit/cd19ac0a7265143cdf2933048f162ec2869c2bd8))
* **scripts:** add session-collision preflight detector (LIA-284) ([#961](https://github.com/sliamh11/Deus/issues/961)) ([0100334](https://github.com/sliamh11/Deus/commit/01003340683c6775cb3cd0056202e4506c688c74))
* **scripts:** classify merge_train rebase conflicts (patterns-only vs mixed) ([#936](https://github.com/sliamh11/Deus/issues/936)) ([d03a24a](https://github.com/sliamh11/Deus/commit/d03a24a238cf15bdd7a8816a2998accdbbb9ed95))
* **skills:** add dual-warden pre-review step to /learn-procedure (3.5) ([#955](https://github.com/sliamh11/Deus/issues/955)) ([7a9af8b](https://github.com/sliamh11/Deus/commit/7a9af8ba5dd81fc21853fba4960de9617d69e570))
* **skills:** add learn-this — vault-native learning companion to /teach ([#899](https://github.com/sliamh11/Deus/issues/899)) ([3d4b389](https://github.com/sliamh11/Deus/commit/3d4b38970013d9146117e31966a95f77ccba88a3))
* **skills:** add linear-slice — plan to dependency-ordered Linear issues ([#897](https://github.com/sliamh11/Deus/issues/897)) ([223e609](https://github.com/sliamh11/Deus/commit/223e60938c9f6f50cecd035b18427fa86693d163))
* **skills:** add Teams + Outlook channel stubs (LIA-310) ([#933](https://github.com/sliamh11/Deus/issues/933)) ([5341f23](https://github.com/sliamh11/Deus/commit/5341f23204f38ab9ef0497e9c476252b9f6ad82e))
* **skills:** import 11 skills from mattpocock/skills (MIT) ([#888](https://github.com/sliamh11/Deus/issues/888)) ([839fa46](https://github.com/sliamh11/Deus/commit/839fa46db0b0f6fe901fdc4c9e75182db98745dd))
* **skills:** import improve-codebase-architecture from mattpocock/skills (MIT) ([#905](https://github.com/sliamh11/Deus/issues/905)) ([cb3323f](https://github.com/sliamh11/Deus/commit/cb3323f4d7d9119da367a947ae4ed36cb883fbac))
* **skills:** render a Decision Receipt at /compress (step 8) ([#956](https://github.com/sliamh11/Deus/issues/956)) ([7ac82ac](https://github.com/sliamh11/Deus/commit/7ac82acb5397f106c4bb2ebf062c5d5a42af89d1))
* **warden:** co-gate wrapper + codex_warden --worktree-root parity (RETRO-2026-06-19-04) ([#904](https://github.com/sliamh11/Deus/issues/904)) ([0e0035f](https://github.com/sliamh11/Deus/commit/0e0035fd1d0f21c960aa94df0e1c4c4d9f8a334a))
* **wardens:** add openai_compat model-review backend (LIA-304 Phase 4) ([#861](https://github.com/sliamh11/Deus/issues/861)) ([03d1e73](https://github.com/sliamh11/Deus/commit/03d1e732a20b47f7dbdc211ba07f99cb87e64e2a))
* **wardens:** add opt-in Z.ai GLM-5.2 model-reviewer backend (glm) ([#902](https://github.com/sliamh11/Deus/issues/902)) ([b734085](https://github.com/sliamh11/Deus/commit/b734085c99cdf5c739e6176873bfb76112812ed8))
* **wardens:** co-gate ai-eng-warden + plan-reviewer; verification→Opus (LIA-303 Phase 3) ([#855](https://github.com/sliamh11/Deus/issues/855)) ([3ebc667](https://github.com/sliamh11/Deus/commit/3ebc66737efb68fff46dad00a77f9aa9cb2c815b))
* **wardens:** no-numb comprehension warden - gated /quiz-me hook + skill (LIA-328) ([#916](https://github.com/sliamh11/Deus/issues/916)) ([74a31d4](https://github.com/sliamh11/Deus/commit/74a31d48ef17ec1189ce45692f564d174681682c))
* **wardens:** provider-agnostic warden backends + GPT/Claude co-gate (Phase 2) ([#839](https://github.com/sliamh11/Deus/issues/839)) ([197e809](https://github.com/sliamh11/Deus/commit/197e8092c2cfea3be9300fe44c2ef12a98cecfc9))


### Bug Fixes

* **agent-runner:** make SendMessage unconditional in allowedTools (LIA-307) ([#867](https://github.com/sliamh11/Deus/issues/867)) ([fbefeda](https://github.com/sliamh11/Deus/commit/fbefeda1a7bb9f596370e92fb549be8da3f9b4e1))
* **bootstrap:** log process-warning stacks for localization (GH [#305](https://github.com/sliamh11/Deus/issues/305)) ([#876](https://github.com/sliamh11/Deus/issues/876)) ([8cadc4c](https://github.com/sliamh11/Deus/commit/8cadc4c0d5c388eb9dea97fff6b48e75ced191f5))
* **cli:** make deus CLI runnable on Linux ([#880](https://github.com/sliamh11/Deus/issues/880)) ([#943](https://github.com/sliamh11/Deus/issues/943)) ([90dda1e](https://github.com/sliamh11/Deus/commit/90dda1e5e4dc2424499b224102646665e302b823))
* **code-search:** bust _cal_cache on reindex so same-process reads aren't stale (LIA-207) ([#891](https://github.com/sliamh11/Deus/issues/891)) ([9e8f849](https://github.com/sliamh11/Deus/commit/9e8f849239bcac7a8935ac2469f45290cb2d3a59))
* **compress:** never delete the CLAUDE.md body on pending-sync ([#881](https://github.com/sliamh11/Deus/issues/881)) ([6eae94d](https://github.com/sliamh11/Deus/commit/6eae94d344ed516eb09cb6b627492fc339d8d690))
* **container:** route entrypoint tsc output to stderr, not stdout (LIA-226) ([#845](https://github.com/sliamh11/Deus/issues/845)) ([9d62924](https://github.com/sliamh11/Deus/commit/9d62924a5f587914a21d25dd3b22117bf70efd12))
* **eval:** guard safety-recall floor against silent fixture-count drift (LIA-326) ([#935](https://github.com/sliamh11/Deus/issues/935)) ([3009567](https://github.com/sliamh11/Deus/commit/30095675e30821eb8963cff0fe9c07ae0dbacf19))
* **eval:** rate-limit-robust the safety-recall gate's Gemini judge (LIA-326) ([#931](https://github.com/sliamh11/Deus/issues/931)) ([3a64ed0](https://github.com/sliamh11/Deus/commit/3a64ed0f577df0aa1c9a2afeb29756f69031d9a0))
* **evolution:** apply think:false body key to qwen3 judge models (qwen3.5 parse fix) ([#940](https://github.com/sliamh11/Deus/issues/940)) ([2da8cfc](https://github.com/sliamh11/Deus/commit/2da8cfc45e22834939b4b32625384ab74db2f156))
* **ingress:** move gateway port default off Odysseus's 3007 + cover it in the port-collision guard (LIA-315) ([#900](https://github.com/sliamh11/Deus/issues/900)) ([a40707d](https://github.com/sliamh11/Deus/commit/a40707d441327d442b5f7a162d751718ff13eddf))
* **ingress:** register webhook chat on inbound to fix silent FK message loss (LIA-315) ([#908](https://github.com/sliamh11/Deus/issues/908)) ([1792479](https://github.com/sliamh11/Deus/commit/179247959f5a7f234e809408a4e2c9eebb3fa261))
* **memory:** confirm file absence before orphaning a tree node (LIA-336) ([#942](https://github.com/sliamh11/Deus/issues/942)) ([41725aa](https://github.com/sliamh11/Deus/commit/41725aa910eef76b45a739ce60452d6b5644edd0))
* **memory:** conflict-resolution model - resolved_at + 3-way invalidate (LIA-338) ([#945](https://github.com/sliamh11/Deus/issues/945)) ([2bc7daf](https://github.com/sliamh11/Deus/commit/2bc7daf409be6bf82412c4a63336f809edfa0f48))
* **memory:** non-destructive single-file auto-memory admit + /learn-procedure fix (LIA-341) ([#949](https://github.com/sliamh11/Deus/issues/949)) ([c610519](https://github.com/sliamh11/Deus/commit/c610519587f0517201c1effb62fb664f15c4e485))
* **memory:** read full frontmatter for id, not a 4096-byte head (LIA-340) ([#946](https://github.com/sliamh11/Deus/issues/946)) ([5aacf07](https://github.com/sliamh11/Deus/commit/5aacf070683ba9242457e62a3f86ea9a9bfad0fe))
* **memory:** tune Web UI consolidation to &gt;=3 turns AND &gt;=500 chars (LIA-295) ([#910](https://github.com/sliamh11/Deus/issues/910)) ([3e55e3a](https://github.com/sliamh11/Deus/commit/3e55e3a5b32efc6c958cc815f391157ea012c509))
* **memory:** unify auto-memory dir resolution + fix feedback-recall read (LIA-341) ([#947](https://github.com/sliamh11/Deus/issues/947)) ([ab6df62](https://github.com/sliamh11/Deus/commit/ab6df62d061ac1ebc4f6dcfa571073c8345aeb7d))
* **multi-agent:** kill silent-DONE in subagent status parsing (LIA-127) ([#948](https://github.com/sliamh11/Deus/issues/948)) ([b577ed5](https://github.com/sliamh11/Deus/commit/b577ed5e6c68555f6df315fd0e1182c276901625))
* **odysseus:** release web turn slot at response-complete, not after wind-down ([#901](https://github.com/sliamh11/Deus/issues/901)) ([3b394a3](https://github.com/sliamh11/Deus/commit/3b394a3bd2bdf306efa933e4dd34ac8fcea97ad2))
* **scheduler:** reject blank cron on the host side (GH [#788](https://github.com/sliamh11/Deus/issues/788)) ([#871](https://github.com/sliamh11/Deus/issues/871)) ([4614922](https://github.com/sliamh11/Deus/commit/46149228732914289960226c0327f1595fa9fd6f))
* **security:** scope workflow token perms + drop shell in 2 setup calls (CodeQL) ([#872](https://github.com/sliamh11/Deus/issues/872)) ([0388e57](https://github.com/sliamh11/Deus/commit/0388e574ad4ae9043433f1b634e1f9942c899f75))
* **skills:** expand leading ~ in /handoff vault path resolution ([#857](https://github.com/sliamh11/Deus/issues/857)) ([341eecd](https://github.com/sliamh11/Deus/commit/341eecd3ea2c17276eb216d70489d487f78c4a51))
* **startup:** abort on ODYSSEUS_HTTP_PORT / LINEAR_WEBHOOK_PORT collision (LIA-301) ([#846](https://github.com/sliamh11/Deus/issues/846)) ([697dd1d](https://github.com/sliamh11/Deus/commit/697dd1db5d261021118aee76433e764e0a7a9d2a))
* **telegram:** catch bot.start() rejection so a polling reset can't kill the channel ([#912](https://github.com/sliamh11/Deus/issues/912)) ([2d8d381](https://github.com/sliamh11/Deus/commit/2d8d3817ec03a6a036faa6e96f9563d5f4994cf9))
* **tool-registry:** fail closed when "tools" is an array + add unit tests (LIA-222) ([#894](https://github.com/sliamh11/Deus/issues/894)) ([0657772](https://github.com/sliamh11/Deus/commit/06577723aa947b2c27c3f17e871ee5a64d1e8929))
* **warden:** diagnose co-gate bucket mismatch instead of a silent not-run ([#914](https://github.com/sliamh11/Deus/issues/914)) ([0ec4ee2](https://github.com/sliamh11/Deus/commit/0ec4ee271f9f92519f3afa25613ff0ac8046adbc))
* **warden:** lock verdict store against parallel-marks clobber (LIA-332) ([#951](https://github.com/sliamh11/Deus/issues/951)) ([857493c](https://github.com/sliamh11/Deus/commit/857493c50172b2c417922ce22f2bf99b4b9bbc64))
* **wardens:** driver records verdicts into the gate's per-worktree bucket ([#868](https://github.com/sliamh11/Deus/issues/868)) ([fe6b312](https://github.com/sliamh11/Deus/commit/fe6b312b76daad96abf012207cf42a2f95d7e38c))
* **wardens:** review non-diff content (plans) instead of discarding it ([#864](https://github.com/sliamh11/Deus/issues/864)) ([ded9e1f](https://github.com/sliamh11/Deus/commit/ded9e1fa0e9e2c4cf91febc8dfcb1ac75dbf5911))
* **wardens:** version-independent glob match + hermetic hook tests in CI (LIA-308) ([#870](https://github.com/sliamh11/Deus/issues/870)) ([bdbc540](https://github.com/sliamh11/Deus/commit/bdbc5403404a1c56d6e8d92af0a677d49c3e350c))
* **webui:** capitalize Deus model label in OWUI ([#887](https://github.com/sliamh11/Deus/issues/887)) ([38ebdf4](https://github.com/sliamh11/Deus/commit/38ebdf4a55b7e46177dabd13399a8cf136fde528))
* **whatsapp:** stay offline on connect so phone push keeps firing (RETRO-2026-06-17-01) ([#879](https://github.com/sliamh11/Deus/issues/879)) ([88ebf70](https://github.com/sliamh11/Deus/commit/88ebf70c7264133711c3765ec8f9f9608559919f))
* **whatsapp:** stop mislabeling intentional shutdown as "Logged out" ([#915](https://github.com/sliamh11/Deus/issues/915)) ([a2605de](https://github.com/sliamh11/Deus/commit/a2605de7b510d255f0e7a6efc9d2dee25ec55ba1))
